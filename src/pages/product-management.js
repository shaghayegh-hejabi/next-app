...
export default function ProductManagement() {
  ...
  style={{
    ...
    backgroundImage: "url('data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 fill=%27%23aaa%27 viewBox=%270 0 24 24%27%3E%3Cpath d=%27M10 18a8 8 0 100-16 8 8 0 000 16zm5-2.93a10 10 0 111.414-1.414l4.486 4.486-1.414 1.414-4.486-4.486z%27/%3E%3C/svg%3E')",
...
>
  ...
  >
   <h3 style={{ margin: 0, fontSize: "24px", padding:"5px" }}>مدیریت کالا</h3>
    <svg
      width="30"
      height="30"
      viewBox="0 0 30 30"
    ...
    >
      ...
      {/* لیست محصولات */}
      <div style={{ border: "1px solid #ddd", padding: "10px" , borderRadius:"4px" , minHeight:"50vh"}}>
        <div
          style={{
            display: "flex",
            justifyContent: "space-between",
      ...
      {isDeleteModalOpen && (
        ...
        >
          ...
          >
            <h2 style={{ marginBottom: "20px" }}>آیا از حذف این محصول مطمئنید؟</h2>
